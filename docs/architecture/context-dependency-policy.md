...
activation, Comms configuration, Limits, Jobs, Notifications, Dashboards, and
Projections ownership paths. Extend the executable ownership map in the same
change whenever another context receives row modules.
