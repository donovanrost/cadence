defmodule Mix.Tasks.Cadence.DataSources.ManagedQuestdbProvision do
  @moduledoc """
  Plans or applies a Cadence-managed QuestDB data-source provision.
  ...
  ## Options
    ...
    * `--data-source-id` - required data-source id
