defmodule Mix.Tasks.Cadence.DataSources.ByoQuestdbSmoke do
  @moduledoc """
  ...
  ## Usage
      ...
      mix cadence.data_sources.byo_questdb_smoke
  ...
  alias Cadence.Smoke.DataSources.BYOQuestDB
  ...
  def run(args) do
    ...
    case BYOQuestDB.run(smoke_opts(opts)) do
      {:ok, result} ->
        Mix.shell().info("""
