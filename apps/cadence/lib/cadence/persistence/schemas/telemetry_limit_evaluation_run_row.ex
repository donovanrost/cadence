defmodule Cadence.Persistence.Schemas.TelemetryLimitEvaluationRunRow do
  @moduledoc false
  ...
  schema "telemetry_limit_evaluation_runs" do
    field(:mission_id, :string)
    field(:organization_id, :string)
    field(:status, :string)
    field(:evaluated_sample_count, :integer)
    field(:emitted_event_count, :integer)
  ...
  def to_domain(%__MODULE__{} = run_row) do
    %Run{
      limit_run_id: run_row.limit_run_id,
      ...
      emitted_event_count: run_row.emitted_event_count,
