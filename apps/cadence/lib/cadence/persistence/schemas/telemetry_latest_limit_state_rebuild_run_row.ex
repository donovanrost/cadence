defmodule Cadence.Persistence.Schemas.TelemetryLatestLimitStateRebuildRunRow do
  ...
  schema "telemetry_latest_limit_state_rebuild_runs" do
    field(:mission_id, :string)
    field(:organization_id, :string)
    field(:status, :string)
    field(:rebuilt_state_count, :integer)
  ...
  @required_fields [:rebuild_run_id, :mission_id, :status, :rebuilt_state_count, :started_at]
  ...
  def to_domain(%__MODULE__{} = run_row) do
    %Run{
      ...
      rebuilt_state_count: run_row.rebuilt_state_count,
  ...
  defp domain_attrs(%Run{} = run) do
    %{
      ...
      rebuilt_state_count: run.rebuilt_state_count,
