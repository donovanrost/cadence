defmodule Cadence.Persistence.Schemas.DashboardDataSourceEventRow do
  @moduledoc false
  ...
  alias Cadence.Dashboards.{DataSourceEvent, SecretMetadata}
  alias Cadence.Persistence.JsonDocument

  @primary_key {:data_source_event_id, :string, autogenerate: false}
  @timestamps_opts [type: :utc_datetime_usec, updated_at: false]

  schema "dashboard_data_source_events" do
  ...
  def changeset(%DataSourceEvent{} = event) do
    ...
    |> foreign_key_constraint(:data_source_id, name: :dashboard_data_source_events_source_fk)
    |> foreign_key_constraint(:organization_id, name: :dashboard_data_source_events_org_fk)
    |> foreign_key_constraint(
      :mission_id,
      name: :dashboard_data_source_events_org_mission_fk
    )
  end
