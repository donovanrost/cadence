defmodule Cadence.DataSources.DataSourceEvent do
  @moduledoc """
  Append-only lifecycle event for a data-source definition.

  The `data_source_definitions` row is the current source descriptor projection.
  ...
  def new(attrs) when is_map(attrs) do
    %__MODULE__{
      data_source_event_id:
        get_attr(attrs, :data_source_event_id) || Ids.new("data_source_definition_event"),
