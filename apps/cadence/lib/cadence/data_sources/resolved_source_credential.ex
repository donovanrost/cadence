defmodule Cadence.DataSources.ResolvedSourceCredential do
  @moduledoc """
  Non-secret credential descriptor returned by the source credential resolver.
  """

  alias Cadence.DataSources.{DataSource, SourceCredentialReference}
