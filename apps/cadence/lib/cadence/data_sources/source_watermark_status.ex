defmodule Cadence.DataSources.SourceWatermarkStatus do
  @moduledoc """
  Latest source-watermark projection for one concrete source identity.
  """

  alias Cadence.DataSources.{SourceWatermark, SourceWatermarkEvent}
