defmodule Cadence.DataSources.SourceWatermarkEvent do
  @moduledoc """
  Append-only data-source watermark transition.
  """
  ...
  def new(attrs) when is_map(attrs) do
    ...
    %__MODULE__{
      source_watermark_event_id:
        get_attr(attrs, :source_watermark_event_id) || Ids.new("data_source_watermark_event"),
      source_watermark_key:
