defmodule Cadence.Runtime.ManagedRecords.ManagedActionRequestRow do
  @moduledoc false
  ...
  schema "managed_action_requests" do
  ...
  @spec changeset(ManagedActionRequest.t()) :: Ecto.Changeset.t()
  ...
  defp domain_attrs(%ManagedActionRequest{} = action_request) do
    %{
