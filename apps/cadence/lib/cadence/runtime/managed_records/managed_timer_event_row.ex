defmodule Cadence.Runtime.ManagedRecords.ManagedTimerEventRow do
  @moduledoc false
  ...
  schema "managed_timer_events" do
  ...
  @spec changeset(ManagedTimerEvent.t()) :: Ecto.Changeset.t()
  def changeset(%ManagedTimerEvent{} = timer_event) do
    %__MODULE__{}
  ...
  defp domain_attrs(%ManagedTimerEvent{} = timer_event) do
    %{
