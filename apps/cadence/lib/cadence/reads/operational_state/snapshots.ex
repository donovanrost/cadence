defmodule Cadence.Reads.OperationalState.Snapshots do
  @moduledoc """
  Reads projected operational intervals and samples as operational snapshots.

  This module owns query-option projection and the shared conversion from
  OperationalEvents records into stable maps consumed by presentation adapters.
  """
