defmodule Cadence.Control.DataSources.ManagedQuestDBProvisioning do
  @moduledoc """
  Provisioning boundary for Cadence-managed QuestDB data sources.

  This module turns an org/mission TSDB isolation intent into a concrete
  data-source registration. It applies the Cadence QuestDB schema
