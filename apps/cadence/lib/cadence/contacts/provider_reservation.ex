defmodule Cadence.Contacts.ProviderReservation do
  ...
  @type t :: %__MODULE__{
          ...
          contact_requirement_id: binary() | nil,
          contact_requirement_version: pos_integer() | nil,
          contact_plan_id: binary() | nil,
          contact_plan_version: pos_integer() | nil,
          contact_opportunity_snapshot_id: binary() | nil,
          transport_id: binary(),
  ...
  def new(attrs) when is_map(attrs) do
    ...
    %__MODULE__{
      ...
      contact_requirement_id: get(attrs, :contact_requirement_id),
      contact_requirement_version: get(attrs, :contact_requirement_version),
      contact_plan_id: get(attrs, :contact_plan_id),
      contact_plan_version: get(attrs, :contact_plan_version),
      contact_opportunity_snapshot_id: get(attrs, :contact_opportunity_snapshot_id),
