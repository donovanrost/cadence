    ...
    with {:ok, starts_at} <- parse_time(string_attrs["starts_at"], :starts_at),
      ...
      {:ok,
       ProviderReservation.new(%{
         ...
         contact_requirement_id: string_attrs["contact_requirement_id"],
         contact_requirement_version: string_attrs["contact_requirement_version"],
         contact_plan_id: string_attrs["contact_plan_id"],
         contact_plan_version: string_attrs["contact_plan_version"],
         contact_opportunity_snapshot_id: string_attrs["contact_opportunity_snapshot_id"],
