defmodule Cadence.Catalog.Telemetry.Compiler do
  @moduledoc """
  Compiles canonical telemetry catalog snapshots into the narrower runtime-facing
  artifacts that Cadence currently executes.

  This compiler intentionally targets the existing definition-bound telemetry
  slice:

  - `Cadence.Telemetry.PacketDefinition`
  - selector-facing inputs for `:definition_bound_telemetry`
