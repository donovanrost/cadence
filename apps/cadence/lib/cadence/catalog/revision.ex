defmodule Cadence.Catalog.Revision do
  ...
  @type t :: %__MODULE__{
          ...
          mission_model_layer_id: binary() | nil,
  ...
  def new(attrs) when is_map(attrs) do
    %__MODULE__{
      ...
      mission_model_layer_id: get(attrs, :mission_model_layer_id),
      mission_model_revision_id: fetch!(attrs, :mission_model_revision_id),
