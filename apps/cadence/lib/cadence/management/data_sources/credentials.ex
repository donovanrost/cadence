defmodule Cadence.Management.DataSources.Credentials do
  @moduledoc """
  Durable registry for data-source credential references.
  ...
  alias Cadence.Management.DataSources.Credentials.EventRow, as: DashboardSourceCredentialEventRow

  alias Cadence.Management.DataSources.Credentials.ReferenceRow,
    as: DashboardSourceCredentialReferenceRow

  alias Cadence.Management.DataSources.Credentials.SecretMaterialResolver
