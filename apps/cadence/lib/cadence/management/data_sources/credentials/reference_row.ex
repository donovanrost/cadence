defmodule Cadence.Management.DataSources.Credentials.ReferenceRow do
  @moduledoc false
  ...
  alias Cadence.DataSources.SourceCredentialReference
  alias Cadence.Persistence.JsonDocument

  @primary_key {:credentials_ref, :string, autogenerate: false}
  @timestamps_opts [type: :utc_datetime_usec]

  schema "data_source_credential_references" do
  ...
  def changeset(%__MODULE__{} = row, %SourceCredentialReference{} = reference) do
    ...
    |> foreign_key_constraint(:organization_id, name: :data_source_credentials_org_fk)
    |> foreign_key_constraint(:mission_id, name: :data_source_credentials_org_mission_fk)
  end
