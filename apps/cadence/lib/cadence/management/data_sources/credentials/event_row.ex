defmodule Cadence.Management.DataSources.Credentials.EventRow do
  @moduledoc false
  ...
  alias Cadence.DataSources.SourceCredentialEvent
  alias Cadence.Persistence.JsonDocument

  @primary_key {:source_credential_event_id, :string, autogenerate: false}
  @timestamps_opts [type: :utc_datetime_usec, updated_at: false]

  schema "data_source_credential_events" do
  ...
  def changeset(%SourceCredentialEvent{} = event) do
    ...
    |> foreign_key_constraint(:credentials_ref, name: :data_source_credential_events_ref_fk)
    |> foreign_key_constraint(:organization_id, name: :data_source_credential_events_org_fk)
    |> foreign_key_constraint(
      :mission_id,
      name: :data_source_credential_events_org_mission_fk
    )
  end
