defmodule Cadence.Management.DataSources.Store.DataBindingEventRow do
  @moduledoc false
  ...
  schema "data_source_binding_events" do
  ...
  def changeset(%DataBindingEvent{} = event) do
    ...
    |> foreign_key_constraint(:binding_id, name: :data_source_binding_events_binding_fk)
    |> foreign_key_constraint(:organization_id, name: :data_source_binding_events_org_fk)
    |> foreign_key_constraint(
      :mission_id,
      name: :data_source_binding_events_org_mission_fk
    )
  end
