defmodule Cadence.Management.DataSources.Store.DataBindingRow do
  @moduledoc false
  ...
  schema "data_source_bindings" do
  ...
  def changeset(%__MODULE__{} = row, %DataBinding{} = data_binding) do
    ...
    |> foreign_key_constraint(:data_source_id, name: :data_source_bindings_data_source_fk)
    |> foreign_key_constraint(:organization_id, name: :data_source_bindings_org_fk)
    |> foreign_key_constraint(:mission_id, name: :data_source_bindings_org_mission_fk)
  end
