defmodule Cadence.Dashboards.Sources.OperationalObservables do
  ...
  def source_backing_contracts, do: source_backing_contract_metadata()
  ...
  def capabilities do
    registry_metadata =
      ...
      |> Map.put(:metric_history_contracts, metric_history_contract_metadata())
      |> Map.put(:source_backing_contracts, source_backing_contract_metadata())
  ...
  def facts(%PlannedSourceRequest{} = request, opts \\ []) when is_list(opts) do
    ...
    with :ok <- ensure_operational_source(request),
         :ok <- ensure_supported_observables(request),
         {:ok, _product} <- supported_product(request),
         {:ok, _mission_id} <- required_request_context(request, :mission_id),
         {:ok, _organization_id} <- required_request_context(request, :organization_id) do
      {:ok,
       SourceFacts.new(%{
         ...
         data_revision:
           Keyword.get(opts, :data_revision) ||
             operational_data_revision(request, source_binding, opts),
  ...
  defp operational_data_revision(%PlannedSourceRequest{} = request, source_binding, opts) do
    with {:ok, product} <- supported_product(request),
  ...
  defp operational_product_revision(
         :contacts_phase,
         request,
         source_binding,
         organization_id,
    ...
    contact_phase_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    connection_state_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    antenna_pointing_state_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    link_rf_lock_state_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    link_rf_frame_sync_state_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    link_rf_metric_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    request.observables
    |> operational_state_history_revision_parts(
      request,
      source_binding,
      organization_id,
      mission_id,
    ...
    |> combined_operational_revision("operational_state_history")
  end
  ...
  defp operational_product_revision(
    ...
    transport_bitrate_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    transport_execution_state_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    managed_runtime_activity_revision(request, source_binding, organization_id, mission_id, opts)
  end
  ...
  defp operational_product_revision(
    ...
    transport_runtime_activity_revision(
      request,
      source_binding,
      organization_id,
      mission_id,
  ...
  defp operational_product_revision(
    ...
    request.observables
    |> operational_metric_history_revision_parts(
      request,
      source_binding,
      organization_id,
      mission_id,
    ...
    |> combined_operational_revision("operational_metric_history")
  end
  ...
  defp operational_product_revision(
    ...
    ingress_processing_latency_revision(
      request,
      source_binding,
      organization_id,
      mission_id,
  ...
  defp operational_product_revision(
    ...
    revision_fun =
      Keyword.get(opts, :command_queue_revision_fun, &default_command_queue_revision/3)
  ...
  defp operational_product_revision(
    ...
    request.observables
    |> operational_latest_revision_parts(
      request,
      source_binding,
      organization_id,
      mission_id,
    ...
    |> combined_operational_revision("operational_latest")
  end
  ...
  defp operational_latest_revision_parts(
         observables,
         request,
         source_binding,
         organization_id,
    ...
    |> maybe_add_family_revision(
      :connection_state,
      Enum.any?(observables, &(&1 in @connection_observable_ids)),
      fn ->
        connection_state_revision(request, source_binding, organization_id, mission_id, opts)
      end
    )
    |> maybe_add_family_revision(
      :ground_station_antenna_pointing_state,
      Enum.any?(observables, &(&1 in @antenna_pointing_observable_ids)),
      fn ->
        antenna_pointing_state_revision(
          request,
          source_binding,
          organization_id,
          mission_id,
    ...
    |> maybe_add_family_revision(
      :link_rf_lock_state,
      Enum.any?(observables, &(&1 in @link_rf_lock_observable_ids)),
      fn ->
        link_rf_lock_state_revision(request, source_binding, organization_id, mission_id, opts)
      end
    )
    |> maybe_add_family_revision(
      :link_rf_frame_sync_state,
      Enum.any?(observables, &(&1 in @link_rf_frame_sync_observable_ids)),
      fn ->
        link_rf_frame_sync_state_revision(
          request,
          source_binding,
          organization_id,
          mission_id,
    ...
    |> maybe_add_family_revision(
      :link_rf_metric,
      Enum.any?(observables, &(&1 in @link_rf_metric_observable_ids)),
      fn ->
        link_rf_metric_revision(request, source_binding, organization_id, mission_id, opts)
      end
    )
    |> maybe_add_family_revision(
      :transport_bitrate,
      Enum.any?(observables, &(&1 in @bitrate_observable_ids)),
      fn ->
        transport_bitrate_revision(request, source_binding, organization_id, mission_id, opts)
      end
    )
    |> maybe_add_family_revision(
      :command_queue_depth,
      "commanding.queue_depth" in observables,
      fn ->
        command_queue_depth_revision(request, source_binding, organization_id, mission_id, opts)
      end
    )
    |> maybe_add_family_revision(
      :ingress_processing_latency,
      "ingress.processing_latency_ms" in observables,
      fn ->
        ingress_processing_latency_revision(
          request,
          source_binding,
    ...
    |> maybe_add_family_revision(
      ...
      Enum.any?(observables, &(&1 in @managed_runtime_observable_ids)),
      fn ->
        managed_runtime_activity_revision(
          request,
          source_binding,
          organization_id,
          mission_id,
    ...
    |> maybe_add_family_revision(
      ...
      Enum.any?(observables, &(&1 in @transport_runtime_observable_ids)),
      fn ->
        transport_runtime_activity_revision(
          request,
          source_binding,
  ...
  defp operational_metric_history_revision_parts(
         observables,
         request,
         source_binding,
         organization_id,
    ...
    |> maybe_add_family_revision(
      :ingress_processing_latency,
      Enum.any?(observables, &(&1 in @ingress_latency_observable_ids)),
      fn ->
        ingress_processing_latency_revision(
          request,
          source_binding,
  ...
  defp maybe_add_family_revision(parts, _family, false, _revision_fun), do: parts

  defp maybe_add_family_revision(parts, family, true, revision_fun) do
    case revision_fun.() do
      revision when is_binary(revision) and revision != "" -> [{family, revision} | parts]
      _other -> parts
    end
  end

  defp combined_operational_revision([], _prefix), do: nil

  defp combined_operational_revision(parts, prefix) do
    prefix <>
      ":" <>
      RuntimeCacheKey.fingerprint(%{family_revisions: Enum.sort_by(parts, &elem(&1, 0))})
  end

  defp contact_phase_revision(request, source_binding, organization_id, mission_id, opts) do
    revision_fun =
      Keyword.get(opts, :contact_phase_revision_fun, &default_contact_phase_revision/3)
  ...
  defp connection_state_revision(request, source_binding, organization_id, mission_id, opts) do
    revision_fun =
      Keyword.get(opts, :connection_state_revision_fun, &default_connection_state_revision/3)
  ...
  defp antenna_pointing_state_revision(
         request,
         source_binding,
         organization_id,
         mission_id,
    ...
    revision_fun =
      Keyword.get(
        opts,
        :antenna_pointing_state_revision_fun,
        &default_antenna_pointing_state_revision/3
      )
  ...
  defp link_rf_lock_state_revision(request, source_binding, organization_id, mission_id, opts) do
    revision_fun =
      Keyword.get(opts, :link_rf_lock_state_revision_fun, &default_link_rf_lock_state_revision/3)
  ...
  defp link_rf_frame_sync_state_revision(
         request,
         source_binding,
         organization_id,
         mission_id,
    ...
    revision_fun =
      Keyword.get(
        opts,
        :link_rf_frame_sync_state_revision_fun,
        &default_link_rf_frame_sync_state_revision/3
      )
  ...
  defp link_rf_metric_revision(request, source_binding, organization_id, mission_id, opts) do
    revision_fun =
      Keyword.get(opts, :link_rf_metric_revision_fun, &default_link_rf_metric_revision/3)
  ...
  defp transport_bitrate_revision(request, source_binding, organization_id, mission_id, opts) do
    revision_fun =
      Keyword.get(opts, :transport_bitrate_revision_fun, &default_transport_bitrate_revision/3)
  ...
  defp transport_execution_state_revision(
         request,
         source_binding,
         organization_id,
         mission_id,
    ...
    revision_fun =
      Keyword.get(
        opts,
        :transport_execution_state_revision_fun,
        &default_transport_execution_state_revision/3
      )
  ...
  defp managed_runtime_activity_revision(
         request,
         source_binding,
         organization_id,
         mission_id,
    ...
    revision_fun =
      Keyword.get(
        opts,
        :managed_runtime_activity_revision_fun,
        &default_managed_runtime_activity_revision/3
      )
  ...
  defp transport_runtime_activity_revision(
         request,
         source_binding,
         organization_id,
         mission_id,
    ...
    revision_fun =
      Keyword.get(
        opts,
        :transport_runtime_activity_revision_fun,
        &default_transport_runtime_activity_revision/3
      )
  ...
  defp ingress_processing_latency_revision(
         request,
         source_binding,
         organization_id,
         mission_id,
    ...
    revision_fun =
      Keyword.get(
        ...
        &default_ingress_processing_latency_revision/3
      )
  ...
  defp command_queue_depth_revision(request, source_binding, organization_id, mission_id, opts) do
    revision_fun =
      Keyword.get(opts, :command_queue_revision_fun, &default_command_queue_revision/3)
  ...
  def resolve(%PlannedSourceRequest{} = request, opts \\ []) when is_list(opts) do
    ...
    with :ok <- ensure_operational_source(request),
         :ok <- ensure_supported_observables(request),
         {:ok, product} <- supported_product(request),
         {:ok, mission_id} <- required_request_context(request, :mission_id),
         {:ok, organization_id} <- required_request_context(request, :organization_id) do
  ...
  defp ensure_supported_observables(%PlannedSourceRequest{} = request) do
    unsupported_observables =
      request.observables
      |> Enum.reject(&OperationalObservable.known?/1)
  ...
  defp metric_history_contract_for_observable(observable_id) when is_binary(observable_id) do
    Enum.find(@metric_history_contracts, fn contract ->
      observable_id in contract.observables
    end)
  end

  defp metric_history_contract_metadata do
  ...
  defp source_backing_contract_metadata do
  ...
  defp metric_history_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @metric_history_observable_ids))
  end

  defp metric_history_observables?(_observables), do: false

  defp latest_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @latest_observable_ids))
  end

  defp latest_observables?(_observables), do: false

  defp state_history_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @state_history_observable_ids))
  end

  defp state_history_observables?(_observables), do: false

  defp connection_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @connection_observable_ids))
  end

  defp connection_observables?(_observables), do: false

  defp antenna_pointing_observables?(observables)
       when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @antenna_pointing_observable_ids))
  end

  defp antenna_pointing_observables?(_observables), do: false

  defp link_rf_lock_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @link_rf_lock_observable_ids))
  end

  defp link_rf_lock_observables?(_observables), do: false

  defp link_rf_frame_sync_observables?(observables)
       when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @link_rf_frame_sync_observable_ids))
  end

  defp link_rf_frame_sync_observables?(_observables), do: false

  defp link_rf_metric_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @link_rf_metric_observable_ids))
  end

  defp link_rf_metric_observables?(_observables), do: false

  defp bitrate_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @bitrate_observable_ids))
  end

  defp bitrate_observables?(_observables), do: false

  defp transport_execution_observables?(observables)
       when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @transport_execution_observable_ids))
  end

  defp transport_execution_observables?(_observables), do: false

  defp managed_runtime_observables?(observables)
       when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @managed_runtime_observable_ids))
  end

  defp managed_runtime_observables?(_observables), do: false

  defp transport_runtime_observables?(observables)
       when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @transport_runtime_observable_ids))
  end

  defp transport_runtime_observables?(_observables), do: false

  defp command_queue_observables?(observables) when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @command_queue_observable_ids))
  end

  defp command_queue_observables?(_observables), do: false

  defp ingress_latency_observables?(observables)
       when is_list(observables) and observables != [] do
    Enum.all?(observables, &(&1 in @ingress_latency_observable_ids))
  end

  defp ingress_latency_observables?(_observables), do: false
  ...
  defp metric_history_product_family(observable_id) when is_binary(observable_id) do
  ...
  defp metric_history_product_family(_observable_id), do: :operational_metric
