defmodule Cadence.Dashboards.SourceCredentials.EnvMaterialResolver do
  @moduledoc """
  Compatibility resolver for env-backed dashboard source credential material.
  ...
  alias Cadence.Dashboards.SourceCredentials.{EnvSecretBackend, SecretMaterialResolver}
