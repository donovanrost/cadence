defmodule Cadence.Dashboards.ManagedQuestDBProvisioningJobs do
  @moduledoc """
  ...
  defp provisioner do
    :cadence
    |> Application.get_env(:dashboard_managed_questdb_provisioning, [])
    |> Keyword.get(:provisioner, &ManagedQuestDBProvisioning.provision/2)
  end

  defp execution_opts do
    config = Application.get_env(:cadence, :dashboard_managed_questdb_provisioning, [])
