defmodule Cadence.Dashboards.DataBindingEvent do
  @moduledoc """
  Append-only lifecycle event for a dashboard data-source binding.

  The `dashboard_data_bindings` row is the current projection. Events preserve
  ...
  def new(attrs) when is_map(attrs) do
    %__MODULE__{
      data_binding_event_id:
        get_attr(attrs, :data_binding_event_id) || Ids.new("dashboard_data_binding_event"),
