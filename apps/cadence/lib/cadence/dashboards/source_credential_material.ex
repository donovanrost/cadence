defmodule Cadence.Dashboards.SourceCredentialMaterial do
  @moduledoc """
  Ephemeral credential material resolved for a dashboard data source.
  ...
  alias Cadence.Dashboards.{DataSource, ResolvedSourceCredential}
