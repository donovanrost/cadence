defmodule Cadence.Dashboards.ManagedQuestDBProvisioningRuns do
  @moduledoc """
  Operator read model for managed QuestDB provisioning jobs.

  This projects durable background jobs into dashboard-facing deployment runs so
  ...
  @type t :: %{
          ...
          required(:status) => TSDBDeploymentStatus.status(),
