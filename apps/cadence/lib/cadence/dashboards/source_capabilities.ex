defmodule Cadence.Dashboards.SourceCapabilities do
  @moduledoc """
  Capability contract advertised by dashboard source adapters.
  ...
  alias Cadence.Dashboards.{ContractNormalization, Frame, PlannedSourceRequest}
  ...
  def normalize(%__MODULE__{} = capabilities) do
    %__MODULE__{
      ...
      | logical_source:
        ...
        supported_time_axes:
          normalize_known_atom_list(capabilities.supported_time_axes, Frame.time_axes()),
        supported_value_types:
          normalize_known_atom_list(capabilities.supported_value_types, [:raw, :engineering]),
        supported_shapes:
          normalize_known_atom_list(capabilities.supported_shapes, Frame.shapes()),
  ...
  def normalize(capabilities) when is_map(capabilities) do
    %__MODULE__{
      logical_source:
        ...
        |> ContractNormalization.known_atom(PlannedSourceRequest.logical_sources()),
      supported_sampling:
        capabilities
      ...
      supported_time_axes:
        ...
        |> normalize_known_atom_list(Frame.time_axes()),
      supported_value_types:
        capabilities
      ...
      supported_shapes:
        ...
        |> normalize_known_atom_list(Frame.shapes()),
      supports_watermarks?:
        capabilities
