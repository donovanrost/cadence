defmodule Cadence.Dashboards.SourceHealthEvent do
  @moduledoc """
  Append-only dashboard source-health transition.

  This is a dashboard/source subsystem fact. It can later be projected into the
  ...
  def new(attrs) when is_map(attrs) do
    ...
    %__MODULE__{
      source_health_event_id:
        get_attr(attrs, :source_health_event_id) || Ids.new("dashboard_source_health_event"),
