defmodule Cadence.Architecture.PlaneBoundary do
  ...
  @plane_file_overrides %{
    ...
    "lib/cadence/dashboards/data_sources.ex" => :composition,
    ...
    "lib/cadence/dashboards/source_execution_policy.ex" => :management,
    "lib/cadence/dashboards/planned_source_request.ex" => :projections,
    "lib/cadence/dashboards/resolved_source_binding.ex" => :management,
    "lib/cadence/dashboards/runtime_cache_key.ex" => :projections,
    "lib/cadence/dashboards/data_sources/source_operations.ex" => :composition,
