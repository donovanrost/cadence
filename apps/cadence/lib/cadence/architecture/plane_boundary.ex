defmodule Cadence.Architecture.PlaneBoundary do
  ...
  @plane_file_overrides %{
    ...
    "lib/cadence/dashboards/data_sources.ex" => :management,
    "lib/cadence/dashboards/data_sources/data_binding_event_row.ex" => :management,
    "lib/cadence/dashboards/data_sources/data_binding_row.ex" => :management,
    "lib/cadence/dashboards/data_sources/data_source_event_row.ex" => :management,
    "lib/cadence/dashboards/data_sources/data_source_row.ex" => :management,
    "lib/cadence/dashboards/data_sources/source_operations.ex" => :projections,
    "lib/cadence/dashboards/data_binding.ex" => :management,
    "lib/cadence/dashboards/data_binding_event.ex" => :management,
    "lib/cadence/dashboards/data_binding_interval.ex" => :management,
    "lib/cadence/dashboards/data_source_event.ex" => :management,
    ...
    "lib/cadence/dashboards/secret_metadata.ex" => :shared,
    ...
    "lib/cadence/dashboards/tsdb_deployment_status.ex" => :control,
    "lib/cadence/dashboards/tsdb_backend_lifecycle_jobs.ex" => :control,
    "lib/cadence/dashboards/source_credentials.ex" => :management,
    "lib/cadence/dashboards/source_credential_event.ex" => :management,
    "lib/cadence/dashboards/source_credential_material.ex" => :management,
    "lib/cadence/dashboards/source_credential_reference.ex" => :management,
    "lib/cadence/dashboards/resolved_source_credential.ex" => :management,
    "lib/cadence/dashboards/source_credentials/event_row.ex" => :management,
    "lib/cadence/dashboards/source_credentials/reference_row.ex" => :management,
    "lib/cadence/dashboards/source_credentials/material_policy.ex" => :management,
    "lib/cadence/dashboards/source_credentials/secret_material_resolver.ex" => :adapter,
    "lib/cadence/dashboards/source_credentials/env_material_resolver.ex" => :adapter,
    "lib/cadence/dashboards/source_credentials/env_secret_backend.ex" => :adapter,
    "lib/cadence/dashboards/source_credentials/external_secret_backend.ex" => :adapter,
    "lib/cadence/dashboards/source_credentials/secret_backend.ex" => :adapter,
    "lib/cadence/dashboards/source_probe_scheduler.ex" => :projections,
    "lib/cadence/dashboards/byo_questdb_smoke.ex" => :composition,
  ...
  @plane_prefix_overrides [
    ...
    management: [
      ...
      "lib/cadence/dashboards/data_sources",
  ...
  @public_cross_plane_sinks MapSet.new([
                              ...
                              "lib/cadence/projections/data_source_health.ex",
