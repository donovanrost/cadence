defmodule Cadence.Repo.Migrations.CreatePhase2GovernedConfigAndLatestProjection do
  ...
  def change do
    ...
    create table(:telemetry_latest_values) do
      ...
      add :packet_id,
          references(:protocol_packet_records, column: :packet_id, type: :string, on_delete: :delete_all),
          null: false

      add :evidence_id,
          references(:ingress_raw_evidence, column: :evidence_id, type: :string, on_delete: :delete_all),
          null: false
