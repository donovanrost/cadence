defmodule Cadence.CCSDS.SDLP.TM.OnlyIdleData do
  @moduledoc """
  Stateful generator and validator for TM Only Idle Data fields.

  The generator implements the 32-cell Fibonacci LFSR from annex D of CCSDS
  132.0-B-3. It is seeded with all ones at device start-up and intentionally
  is not restarted between subsequent OID Transfer Frames.
  """
