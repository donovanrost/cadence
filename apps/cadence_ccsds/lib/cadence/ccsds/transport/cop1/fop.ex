defmodule Cadence.CCSDS.Transport.COP1.FOP do
  ...
  alias Cadence.CCSDS.Transport.COP1.FOP.Transition
  ...
  @doc """
  Application adapter for one pre-framed command release.

  The adapter preserves Cadence's release-level start/completion correlation
  while the FOP state itself uses the standard Sent_Queue and V(S)/NN(R)
  variables. It is only available in synchronous lower-layer mode.
  """
