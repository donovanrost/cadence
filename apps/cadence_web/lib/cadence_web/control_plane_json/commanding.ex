defmodule CadenceWeb.ControlPlaneJSON.Commanding do
  @moduledoc "Resource-owned JSON boundary for the Commanding vertical."
  ...
  def staged_command_item(%StagedCommandItem{} = item) do
    %{
      ...
      command_snapshot_id: item.command_snapshot_id,
  ...
  def command_verifier_instance(%CommandVerifierInstance{} = verifier) do
    %{
      ...
      command_snapshot_id: verifier.command_snapshot_id,
