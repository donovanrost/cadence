defmodule CadenceWeb.OpsDashboardShowLive.HistoricalWorkflowContext do
  ...
  @type t :: %__MODULE__{
          ...
          job_started_at: String.t() | nil,
          job_completed_at: String.t() | nil,
          ...
          stale_replacement_job_started_at: String.t() | nil,
          stale_replacement_job_age_seconds: String.t() | nil,
          stale_replacement_stale_after_seconds: String.t() | nil,
          missing_replacement_run_id: String.t() | nil,
          missing_replacement_expected_job_type: String.t() | nil,
  ...
  defstruct [
    ...
    :retry_blockers,
    :recovery_action,
    :stale_replacement_job_started_at,
    :stale_replacement_job_age_seconds,
    :stale_replacement_stale_after_seconds,
    :missing_replacement_run_id,
    :missing_replacement_expected_job_type,
  ...
  def build(inspector) when is_map(inspector) do
    ...
    %__MODULE__{
      ...
      comparison_review_scope_kind: row_value(rows, "Comparison review scope kind"),
      comparison_review_scope_ids: row_value(rows, "Comparison review scope ids"),
      comparison_review_contact_ids: row_value(rows, "Comparison review contact ids"),
      comparison_review_resource_ids: row_value(rows, "Comparison review resource ids"),
      comparison_review_transport_ids: row_value(rows, "Comparison review transport ids"),
      comparison_review_source_endpoint_ids:
        row_value(rows, "Comparison review source endpoint ids"),
      comparison_review_ground_station_ids:
        row_value(rows, "Comparison review ground station ids"),
      comparison_review_scope_link_ids: row_value(rows, "Comparison review scope link ids"),
      ...
      job_started_at: row_value(rows, "Workflow job started"),
      job_completed_at: row_value(rows, "Workflow job completed"),
      ...
      stale_replacement_job_started_at: row_value(rows, "Stale replacement job started"),
      stale_replacement_job_age_seconds: row_value(rows, "Stale replacement job age seconds"),
      stale_replacement_stale_after_seconds:
        row_value(rows, "Stale replacement stale after seconds"),
      missing_replacement_run_id: row_value(rows, "Missing replacement run"),
      missing_replacement_expected_job_type:
        row_value(rows, "Missing replacement expected job type"),
