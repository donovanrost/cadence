defmodule CadenceWeb.OpsDashboardShowLive.ComparisonInvestigationPreset do
  ...
  defp selection_query(item) when is_map(item) do
    %{
      ...
      "selected_scope_ids" => item |> map_value(:scope_ids) |> string_list_text(),
      ...
      "selected_contact_ids" => item |> map_value(:contact_ids) |> string_list_text(),
