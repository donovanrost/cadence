defmodule CadenceWeb.OpsDashboardShowLive.RuntimeReplayTransportFailedEvidenceCycleTwo do
  @moduledoc false
  ...
  def run(context) do
    %{
      ...
      conn: conn,
      current_view: reopened_deep_again_matched_record_event_view,
    ...
    %{context | current_view: reopened_deep_again_record_event_verifier_matched_record_event_view}
  end
end
