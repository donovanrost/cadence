defmodule CadenceWeb.OpsDashboardShowLive.GoldenContractTransportMetricMissingSnapshotTest do
    ...
    result =
      Engine.resolve(
        ...
        operational_source_registry_opts(
          source_opts: operational_metric_missing_snapshot_source_opts(parent),
  ...
  defp operational_metric_missing_snapshot_source_opts(parent) do
    %{
