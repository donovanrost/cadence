defmodule CadenceWeb.OpsDashboardShowLive.HistoricalWorkflowComparisonReviewBulkDecisionLiveTest do
  ...
  describe "comparison-review bulk revision decisions" do
    ...
    test "applies bulk comparison review decisions only to actionable findings" do
      ...
      assert updated.validity_state == :conflict
    end
  end
end
