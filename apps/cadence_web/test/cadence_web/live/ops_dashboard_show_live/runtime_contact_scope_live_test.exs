defmodule CadenceWeb.OpsDashboardShowLive.RuntimeContactScopeLiveTest do
  ...
  defp track_dashboard_view(%{pid: pid} = view) when is_pid(pid) do
    tracked_views = Process.get(:ops_dashboard_runtime_contact_scope_views, MapSet.new())

    unless MapSet.member?(tracked_views, pid) do
      Process.put(:ops_dashboard_runtime_contact_scope_views, MapSet.put(tracked_views, pid))

      on_exit({:ops_dashboard_runtime_contact_scope_view, pid}, fn ->
