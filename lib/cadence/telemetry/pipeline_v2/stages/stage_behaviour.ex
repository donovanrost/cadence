defmodule Cadence.Telemetry.PipelineV2.Stages.StageBehaviour do
  @moduledoc """
  ...
  """
  @callback process(
              event :: Cadence.Telemetry.PipelineV2.PipelineEvent.t(),
              state :: map()
            ) ::
              {:ok, Cadence.Telemetry.PipelineV2.PipelineEvent.t()}
              | {:skip, term()}
              | {:error, term()}
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      @behaviour Cadence.Telemetry.PipelineV2.Stages.StageBehaviour
