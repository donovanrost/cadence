defmodule CadenceWeb.OrganizationLive.FormComponent do
    ...
    <div>
      ...
      >
        ...
        <.input
          ...
          options={[{"Active", "active"}, {"Suspended", "suspended"}, {"Terminated", "terminated"}]}
        />
        <.input
        ...
        />
        <.input field={@form[:max_missions]} type="number" label="Max Missions" />
        <.input field={@form[:max_targets_per_mission]} type="number" label="Max Targets Per Mission" />
        <.input field={@form[:max_users]} type="number" label="Max Users" />
        <.input field={@form[:storage_quota_gb]} type="number" label="Storage Quota (GB)" />
        <:actions>
