...
export const OpsConsoleHook = {
  ...
  async _init() {
    ...
    try {
      // Initialize GridStack directly on the hook element
      // Nav and Context panels are now server-rendered LiveComponents
      this.gridManager = createGridManager(this.el)
  ...
  _updateToolbar() {
    // Toolbar is no longer rendered by JS - panels are now server-rendered LiveComponents
    // Widget controls are handled through the UI directly
  },
