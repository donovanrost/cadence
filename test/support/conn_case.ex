defmodule CadenceWeb.ConnCase do
  ...
  by setting `use CadenceWeb.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Cadence.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Cadence.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
