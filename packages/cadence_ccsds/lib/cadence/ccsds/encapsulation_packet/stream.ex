defmodule Cadence.CCSDS.EncapsulationPacket.Stream do
  @moduledoc """
  Incremental Encapsulation Packet extraction from arbitrary byte chunks.
  """

  alias Cadence.CCSDS.EncapsulationPacket.Codec

  @spec decode(binary(), keyword()) ::
          {:ok, [Cadence.CCSDS.EncapsulationPacket.t()], binary()} | {:error, term()}
