defmodule Cadence.CCSDS.Conformance.HermesVerifier do
  ...
  defp verify_line(
    ...
    packet = expect_ok(SpacePacketCodec.decode(wire), "Cadence rejected Hermes packet")
  ...
  defp verify_line(
    ...
    frame =
      expect_single(
        ...
        "Cadence rejected Hermes TC frame"
      )
  ...
  defp verify_line(
    ...
    frame =
      expect_single(
        ...
        "Cadence rejected Hermes TM frame"
      )
...
Cadence.CCSDS.Conformance.HermesVerifier.run(IO.stream(:stdio, :line))
