...
It compares Cadence with the independently implemented Python `spacepackets`
package:
...
The run passed 128 Cadence-generated PDUs through the independent parser and
re-encoder. It then passed 11 independently constructed PDUs back through the
Cadence decoder and exact re-encoder. The cases cover Metadata, File Data,
...
differential cases therefore use the common width set; the Cadence-only seeded
