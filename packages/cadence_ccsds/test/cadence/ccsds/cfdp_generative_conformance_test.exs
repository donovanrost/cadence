defmodule Cadence.CCSDS.CFDP.GenerativeConformanceTest do
  use ExUnit.Case, async: false

  alias Cadence.CCSDS.CFDP.{Codec, FileData, PDU, Stream}
  ...
  alias Cadence.CCSDS.CFDP.TLV.{FlowLabel, MessageToUser}
