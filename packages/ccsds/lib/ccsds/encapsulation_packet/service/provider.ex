defmodule CCSDS.EncapsulationPacket.Service.Provider do
  @moduledoc """
  ...
  alias CCSDS.EncapsulationPacket.{Codec, Configuration}
  alias CCSDS.EncapsulationPacket.Service.{Indication, Request}
