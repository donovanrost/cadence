defmodule CCSDS.SDLP.USLP.Service.Provider do
  @moduledoc """
  ...
  alias CCSDS.SDLP.USLP.{Configuration, Continuity, FrameCodec, Reassembly, Segmentation}
  alias CCSDS.SDLP.USLP.Service.{Indication, Request}
