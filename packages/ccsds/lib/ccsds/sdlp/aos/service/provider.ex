defmodule CCSDS.SDLP.AOS.Service.Provider do
  @moduledoc """
  ...
  alias CCSDS.SDLP.AOS.{Configuration, Continuity, FrameCodec, Reassembly, Segmentation}
  alias CCSDS.SDLP.AOS.Service.{Indication, Request}
