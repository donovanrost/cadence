defmodule CCSDS.NormativeVectorsTest do
  use ExUnit.Case, async: true

  alias CCSDS.CFDP.{Checksum, FileData, PDU, TransactionID}
  alias CCSDS.CFDP.Codec, as: CFDPCodec
  alias CCSDS.CFDP.Directive.{EndOfFile, Metadata}
  alias CCSDS.CFDP.UserOperation.Codec, as: UserOperationCodec
  ...
  alias CCSDS.ChannelCoding.{BCH, CLTU, Configuration, LDPC, Randomizer}
  alias CCSDS.Core.LinkFrame
  alias CCSDS.EncapsulationPacket
  alias CCSDS.EncapsulationPacket.Codec, as: EncapsulationPacketCodec
  alias CCSDS.EncapsulationPacket.Configuration, as: EncapsulationConfiguration
  alias CCSDS.FrameErrorControl
  alias CCSDS.SDLP.AOS.BPDU
  alias CCSDS.SDLP.AOS.Configuration, as: AOSConfiguration
  alias CCSDS.SDLP.AOS.FrameCodec, as: AOSFrameCodec
  alias CCSDS.SDLP.AOS.FrameHeaderErrorControl
  alias CCSDS.SDLP.AOS.MPDU
  alias CCSDS.SDLP.AOS.OnlyIdleData, as: AOSOnlyIdleData
  alias CCSDS.SDLP.TM.{FrameCodec, OnlyIdleData, SecondaryHeader}
  alias CCSDS.SDLP.USLP.Configuration, as: USLPConfiguration
  alias CCSDS.SDLP.USLP.FrameCodec, as: USLPFrameCodec
  alias CCSDS.SDLP.USLP.OnlyIdleData, as: USLPOnlyIdleData
  alias CCSDS.SDLS.{Channel, SecurityAssociation, SecurityHeader}
  alias CCSDS.SpacePacket
  alias CCSDS.SpacePacket.Codec
  alias CCSDS.TC.{SegmentHeader, TransferFrame}
  alias CCSDS.TestSupport.NormativeVectors
  alias CCSDS.Time.CDS
  alias CCSDS.Time.CDS.Codec, as: CDSCodec
  alias CCSDS.Time.CDS.Configuration, as: CDSConfiguration
  alias CCSDS.Time.CUC
  alias CCSDS.Time.CUC.Codec, as: CUCCodec
