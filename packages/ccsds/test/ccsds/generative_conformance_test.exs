defmodule CCSDS.GenerativeConformanceTest do
  ...
  alias CCSDS.SDLP.TM.FrameCodec, as: TMFrameCodec
  alias CCSDS.SDLP.USLP.Configuration, as: USLPConfiguration
  alias CCSDS.SDLP.USLP.FrameCodec, as: USLPFrameCodec
  alias CCSDS.SDLS.{ApplyRequest, Channel, ProcessRequest}
  alias CCSDS.SDLS.Provider, as: SDLSProvider
  alias CCSDS.SDLS.SecurityAssociation
  ...
  alias CCSDS.TestSupport.SDLSTestCryptoProvider
