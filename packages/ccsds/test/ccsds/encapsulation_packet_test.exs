defmodule CCSDS.EncapsulationPacketTest do
  use ExUnit.Case, async: true

  alias CCSDS.EncapsulationPacket
  alias CCSDS.EncapsulationPacket.{Codec, Configuration, Idle, Stream}
  alias CCSDS.EncapsulationPacket.Service.{Provider, Request}
  ...
  test "managed Packet Services delimit adaptive PVN-7 packets" do
    {:ok, space_packet} =
      CCSDS.SpacePacket.Codec.encode(%CCSDS.SpacePacket{
        version: 0,
