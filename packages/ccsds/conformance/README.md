...
CCSDS_GENERATIVE_CASES=10000 CCSDS_GENERATIVE_SEED=20260720 \
  mix test test/ccsds/generative_conformance_test.exs
```
...
transfer frames with and without secondary headers. Library-generated bytes
are decoded and independently re-encoded by Hermes; Hermes-generated bytes
are then decoded by this library.
