defmodule Cadence.Repo.Migrations.CreateMdbDefinitionSets do
  ...
  def change do
    ...
    create unique_index(:mdb_definition_sets, [:mission_id, :version],
             name: :mdb_definition_sets_mission_version_index
           )

    create index(:mdb_definition_sets, [:mission_id, :published_at, :superseded_at],
             name: :mdb_definition_sets_active_index
           )
  end
end
