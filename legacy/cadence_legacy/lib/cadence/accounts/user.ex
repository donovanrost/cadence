defmodule Cadence.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :missions, through: [:mission_memberships, :mission]
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Cadence.Repo)
  ...
  """
  def valid_password?(%Cadence.Accounts.User{hashed_password: hashed_password}, password)
